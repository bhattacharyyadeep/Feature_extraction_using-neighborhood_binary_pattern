...
distance=dist;
    ...
    t=0;
    for i=1:24 % getting the top 25 distance of the query image using minimum distances.
    ...
    precision_sum=precision_sum+(t/24); % calculating precision over each category here we have 112 categories.
    t=0;
end
